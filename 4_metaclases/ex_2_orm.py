...
print(User.storage.get_by_field(first_name='Bohdan'))
print(User.storage.delete(first_name='Bohdan'))
print(User.storage.get_by_field(first_name='Bohdan'))

try:
    print(User.storage.get_by_field(first_name='Bohdan', single=True))
