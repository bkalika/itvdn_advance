...
class UserTestCase(unittest.TestCase):
    ...
    @unittest.mock.patch('ex_5_mock.sum_two_values')
    ...
    @unittest.mock.patch('ex_5_mock.sum_two_values', return_value=20)
    def test_mock_return_value_in_dec(self, mocked_sum):
        res1 = sum_two_values(10, 40)
        res2 = sum_two_values(110, 140)
        res3 = sum_two_values(1110, 1140)
    ...
    def test_mock_side_effect(self, mocked_sum):
        ...
        self.assertEqual(sum_two_values(110, 0), result)
    ...
    def test_mock_return_value_in_body_with(self):
        with unittest.mock.patch('ex_5_mock.sum_two_values') as mocked_sum:
            mocked_sum.return_value = 20
            res1 = sum_two_values(10, 40)
            res2 = sum_two_values(110, 140)
            res3 = sum_two_values(1110, 1140)
    ...
    def test_mock_builtin(self):
        with unittest.mock.patch('datetime.datetime') as mocked_datetime:
            actual_date = datetime.datetime(2020, 1, 1, 29, 4, 6)

            mocked_datetime.now.return_value = actual_date
            res1 = datetime.datetime.now()
            self.assertEqual(res1, actual_date)
